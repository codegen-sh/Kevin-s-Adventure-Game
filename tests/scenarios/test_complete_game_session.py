...
class TestNewPlayerGameSession:
    ...
    def test_new_player_exploration_scenario(self, mock_print):
        ...
        # Verify final state
        expected_items = {"map", "bread", "stick", "berries", "torch", "rope", "pickaxe"}
...
class TestGameProgressionScenarios:
    ...
    def test_character_progression_scenario(self, mock_print):
        ...
        progression_actions = [
            # Exploration phase
            "look", "take map", "take bread",
            "go forest", "take stick", "take berries",
            "go cave", "take torch", "take gemstone",
            
            # Item usage phase
            "use bread",  # Heal
            "go forest", "use stick",  # Find gold coin
            "go village", "use gemstone",  # Sell for gold
            
            # Advanced exploration
            "go mountain", "take rope", "take pickaxe",
            "use rope",  # Improve climbing
        ]
        
        with patch('builtins.input', return_value='y'), \
             patch('utils.random_events.generate_random_event', return_value="heal"):
...
class TestCompleteGameplaySession:
    ...
    def test_full_adventure_scenario(self, mock_print):
        ...
        adventure_sequence = [
            ...
            # Exploration phase
            "take map", "take bread",
            "go forest", "look", "take stick", "take berries",
            "go cave", "look", "take torch", "take gemstone",
            "go forest", "go village", "go mountain", "look",
            "take rope", "take pickaxe",
            
            # Interaction phase
            "go village", "interact",
            "go forest", "interact", 
            "go cave", "interact",
            "go forest", "go village", "go mountain", "interact",
            
            # Item usage phase
            "use map", "use bread", "use rope",
            "go village", "use gemstone",
            "go forest", "use stick",
            "go cave", "use torch",
