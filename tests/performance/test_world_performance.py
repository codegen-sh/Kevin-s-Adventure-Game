...
class TestLocationInteractionPerformance:
    ...
    def test_village_interaction_speed(self, mock_village, benchmark, sample_world, sample_player):
    ...
    def test_forest_interaction_speed(self, mock_forest, benchmark, sample_world, sample_player):
    ...
    def test_cave_interaction_speed(self, mock_cave, benchmark, sample_world, sample_player):
    ...
    def test_mountain_interaction_speed(self, mock_mountain, benchmark, sample_world, sample_player):
    ...
    def test_world_with_many_items_performance(self, benchmark):
        ...
        def create_item_heavy_world():
            ...
            for location in world["locations"]:
                world["locations"][location]["items"] = [f"item_{i}" for i in range(100)]
            return world
...
class TestConcurrentWorldOperations:
    ...
    def test_rapid_location_changes(self, benchmark):
        ...
        def rapid_changes():
            changes = [
                "Forest", "Village", "Forest", "Cave", "Forest", "Village",
                "Mountain", "Village", "Forest", "Cave", "Forest", "Village"
            ]
...
class TestWorldPerformanceRegression:
    ...
    def test_world_operation_consistency(self, benchmark):
        ...
        def consistent_operations():
            ...
            return max_deviation < avg_time * 2  # No operation should take more than 2x average
