...
from game.actions import (handle_drop_item, handle_inventory, handle_look,
                          handle_movement, handle_status, handle_take_item,
                          handle_use_item, perform_action)
...
class TestPerformAction:
    ...
    def test_perform_action_go_command(
        self, mock_handle_movement, sample_player, sample_world
    ):
        """Test performing a 'go' movement command."""
        perform_action(sample_player, sample_world, "go forest")

        mock_handle_movement.assert_called_once_with(
            sample_player, sample_world, "Forest"
        )

    @patch("game.actions.handle_movement")
    def test_perform_action_move_command(
        self, mock_handle_movement, sample_player, sample_world
    ):
        ...
        mock_handle_movement.assert_called_once_with(
            sample_player, sample_world, "Mountain"
        )

    @patch("game.actions.handle_take_item")
    def test_perform_action_take_command(
        self, mock_handle_take, sample_player, sample_world
    ):
    ...
    @patch("game.actions.handle_take_item")
    def test_perform_action_pick_up_command(
        self, mock_handle_take, sample_player, sample_world
    ):
    ...
    def test_perform_action_drop_command(
        self, mock_handle_drop, sample_player, sample_world
    ):
    ...
    def test_perform_action_use_command(
        self, mock_handle_use, sample_player, sample_world
    ):
    ...
    def test_perform_action_look_commands(
        self, mock_handle_look, sample_player, sample_world
    ):
    ...
    def test_perform_action_inventory_commands(
        self, mock_handle_inventory, sample_player, sample_world
    ):
    ...
    def test_perform_action_status_commands(
        self, mock_handle_status, sample_player, sample_world
    ):
    ...
    def test_perform_action_interact_commands(
        self, mock_interact, sample_player, sample_world
    ):
    ...
    @patch("game.actions.print_invalid_action")
    def test_perform_action_invalid_command(
        self, mock_print_invalid, sample_player, sample_world
    ):
    ...
    def test_perform_action_empty_string(self, sample_player, sample_world):
        ...
        with patch("game.actions.print_invalid_action") as mock_print_invalid:
...
class TestHandleUseItem:
    ...
    @patch("builtins.print")
    def test_handle_use_item_not_in_inventory(
        self, mock_print, sample_player, sample_world
    ):
...
class TestHandleStatus:
    ...
    @patch("builtins.print")
    @patch("game.actions.handle_inventory")
    def test_handle_status_damaged_player(
        self, mock_handle_inventory, mock_print, damaged_player
    ):
