...
class TestRemoveItemFromInventory:
    ...
    def test_remove_nonexistent_item(self, mock_print, player_with_items):
        ...
        mock_print.assert_called_once_with("You don't have nonexistent in your inventory.")
...
class TestHealPlayer:
    ...
    def test_heal_damaged_player(self, mock_print, damaged_player):
        ...
        mock_print.assert_called_once_with("You healed for 30 health. Current health: 80")
    ...
    def test_heal_player_to_max_health(self, mock_print, damaged_player):
        ...
        mock_print.assert_called_once_with("You healed for 100 health. Current health: 100")
    ...
    def test_heal_healthy_player(self, mock_print, sample_player):
        ...
        mock_print.assert_called_once_with("You healed for 20 health. Current health: 100")
    ...
    def test_heal_with_zero_amount(self, mock_print, damaged_player):
        ...
        mock_print.assert_called_once_with(f"You healed for 0 health. Current health: {initial_health}")
...
class TestDamagePlayer:
    ...
    @patch('builtins.print')
    @patch('utils.text_formatting.print_game_over')
    ...
    @patch('builtins.print')
    @patch('utils.text_formatting.print_game_over')
    def test_damage_player_exactly_to_zero(self, mock_game_over, mock_print, sample_player):
