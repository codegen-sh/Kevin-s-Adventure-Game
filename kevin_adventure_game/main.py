...
from kevin_adventure_game.utils.text_formatting import (
    print_help,
...
def parse_args():
    ...
    parser.add_argument(
        "--new",
        action="store_true",
        help="Start a new game, ignoring any saves",
    )
    parser.add_argument(
            ...
            if load_option == "y":
                ...
                if save_files:
                    ...
                    try:
                        choice = int(
                            input(
                                "Enter the number of the save file to load (or 0 to start new): "
                            )
                        )
                        if choice == 0:
