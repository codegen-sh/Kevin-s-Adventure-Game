...
def get_item_description(item):
    item_descriptions = {
        ...
        "mountain_herbs": (
            "Rare medicinal herbs found on the mountain. "
            "They might have healing properties."
        ),
        "ancient_coin": (
            "An old coin with strange markings. " "It might be valuable to collectors."
        ),
        "hermit's_blessing": (
            "A mystical blessing from the mountain hermit. " "It fills you with energy."
        ),
        ...
        "ancient_artifact": (
            "A mysterious object from a long-lost civilization. "
            "Its purpose is unknown."
        ),
        "magic_ring": (
            "A ring imbued with magical properties. "
            "Its effects are yet to be discovered."
        ),
        "mysterious_potion": (
            "A vial containing a strange, swirling liquid. " "Its effects are unknown."
        ),
